<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Editando venta</li>
                  ...
                  <div class="col-xs-6" style="padding-right:0px">
                    ...
                    <div class="input-group">
                      ...
                      <select class="form-control" id="tipo" name="tipo" readonly>
                        <option value="<?php echo $venta["tipo"]; ?>"><?php echo $venta["tipo"]; ?></option>
                  ...
                  <div class="col-xs-6" style="padding-right:0px">
                     ...
                     <div class="input-group">
                      ...
                      <select class="form-control" id="status" name="status" required>
                        <option value="<?php echo $venta["status"]; ?>">Status <?php echo $venta["status"]; ?></option>

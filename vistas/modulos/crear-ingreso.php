        ...
        <div class="box box-success">
          ...
          <form role="form" method="post" class="formularioVenta">
              ...
              <div class="box">
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    $ventas = Controladoringresos::ctrMostrarIngresos($item, $valor);
            ...
            <div class="box-footer">
              ...
              <button type="submit" class="btn btn-primary pull-right">Guardar Compra de material</button>
          ...
          $guardarVenta = new ControladorIngresos();
          $guardarVenta -> ctrCrearIngreso();
            ...
            <div class="form-group row">
              ...
              <div class="col-xs-6" style="padding-right:0px">
                ...
                <div class="input-group">
                  ...
                  <select class="form-control" id="tipoUsuario" name="tipoUsuario" readonly>

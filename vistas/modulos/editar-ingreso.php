<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Editando Ingreso</li>
    ...
    <div class="row">
      ...
      <div class="col-lg-5 col-xs-12">
            ...
            <div class="box-body">
              ...
              <div class="box">
                ...
                <?php
                    ...
                    $venta = ControladorIngresos::ctrMostrarIngresos($item, $valor);
                    ...
                    $cliente = ControladorClientes::ctrMostrarClientes($itemCliente, $valorCliente);
                     ...
                     $venta["impuesto"] != 0 ? $porcentajeImpuesto =  $venta["impuesto"] * 100 / $venta["neto"] : $porcentajeImpuesto = 0;
                  ...
                  echo '<div class="row" style="padding:5px 15px">
                        ...
                        <div class="col-xs-3 ingresoPrecio" style="padding-left:0px">
                          ...
                          <div class="input-group">
                            ...
                            <input type="text" class="form-control nuevoPrecioProducto" precioReal="'.$respuesta["precio_compra"].'" name="nuevoPrecioProducto" value="'.$respuesta["precio_compra"]*$value["cantidad"].'" readonly required>
                  ...
                  <div class="col-xs-6" style="padding-right:0px">
                     ...
                     <div class="input-group">
                      ...
                      <select class="form-control" id="nuevoMetodoPago" name="nuevoMetodoPago" required>
                        <option value="<?php echo $venta["metodo_pago"]; ?>">Pagado con: <?php echo $venta["metodo_pago"]; ?></option>
        ...
        <?php
          ...
          $editarVenta = new ControladorIngresos();
          $editarVenta -> ctrEditarIngreso();

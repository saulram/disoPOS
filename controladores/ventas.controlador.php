...
class ControladorVentas{
	...
	static public function ctrCrearVenta(){
		...
		if(isset($_POST["tipo"])){
			echo ("<script>console.log(siviene)</script>");
		}
		...
		if(isset($_POST["nuevaVenta"])){
			...
			if($respuesta == "ok"){
					...
					//AGREGAR AQUI, LA DESCARGA DEL PDF CON LA VENTA COMPLETA
	...
	public function ctrDescargarReporte(){
		...
		if(isset($_GET["reporte"])){
			...
			//Me recorre todas las ventas una por una
			foreach ($ventas as $row => $item){
				...
				$item["impuesto"] == 0 ? $descuento = 0 : $descuento = ($item["impuesto"]*100) /$item["neto"];
						
						
						$item["tipo"]=="Mayoreo" ? $estilo ="background:#039be5;color:#fff" : $estilo ="background:#00897b;color:#fff";
				...
				//Me recorre todos los productos de cada venta
			 	foreach ($productos as $key => $valueProductos) {
					
						
						
			 			$totalProductos = $totalProductos + $valueProductos["cantidad"];
						echo utf8_decode("<tr><td style='border:1px solid #eee;'>".$item["codigo"]."</td> 
						...
						<td style='border:1px solid #eee;'>".$item["status"]."</td>
						<td style='border:1px solid #eee;".$estilo."'>".$item["tipo"]."</td></tr>"

						);
			 			

					 }
					 //cuando termina el for de los productos, me insertas una linea con los datos totales de la venta


					 echo utf8_decode("<tr><td style='border:1px solid #eee;'>".$item["codigo"]."</td> 
						<td style='border:1px solid #eee;'>".$cliente["nombre"]."</td>
						<td style='border:1px solid #eee;'>".$vendedor["nombre"]."</td>
						<td style='border:1px solid #eee;'>".$totalProductos."</td>
						<td style='border:1px solid #eee;'>Total Venta</td>
						...
						//terminas de imprimir el bloque de la venta "n"
			...
			}//fin del foreach venta, lo repite N veces de acuerdo al numero de ventas.
